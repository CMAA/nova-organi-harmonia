...
\header {
  title = \markup \center-column {"Haec dies. V/. Benedictus" \vspace #1 }
  tagline = ""
  composer = ""
}
 ...
 #(include-special-characters)
  oddHeaderMarkup = \markup \fill-line {
    ...
    \center-column {
      ...
      \on-the-fly #not-first-page "Haec dies. V/. Benedictus"
    }
    \line { \on-the-fly #print-page-number-check-first \fromproperty #'page:page-number-string }
  }
  evenHeaderMarkup = \markup \fill-line {
    \line { \on-the-fly #print-page-number-check-first \fromproperty #'page:page-number-string }
    \center-column { "Haec dies. V/. Benedictus" }
    \line {}
  }
}
...
Be -- ne -- dí -- ctus qui ve -- _ _ _ _ _ _ _ _ _ nit 
in nó -- mi -- ne Dó -- _ _ _ _ _ _ _ mi -- ni: 
De -- us Dó -- _ _ _ mi -- nus, _ _ _ _ _ 
et il -- lú -- _ xit 
\set stanza = " * " no -- _ bis. _ _ _ }
...
\tieDown    fis'4 ( e'4) g'4 ( fis'4 e'4) fis'4 ( d'4) fis'4 ( a'4) a'4 ( a'4) ~ a'4 ( fis'4 e'4) fis'4 ( e'4 fis'4) fis'4 \divisioMaior
 ...
 a'4 ( b'4) cis''4 ( b'4 a'4 gis'4) a'4 ( fis'4 e'4) \divisioMinima
 ...
 b'4 d''4 ( b'4 cis''\prall d''4 cis''4 b'4) b'4 b'4 ( cis''4) cis''4 ( a'4) cis''4 ( b'4 a'4) ~ a'4 ( fis'4) a'4 ( a'4 fis'4) a'4. ~ a'4 ( a'4 \forceBreak
) ~ a'4 ( fis'4) \divisioMinima
 a'4 ( b'4 cis''4 b'4 a'4) cis''4 ( b'4 a'4 b'4) fis'4 ( gis'\prall a'4 fis'4) fis'4 \divisioMaxima
 a'4 ( a'4) a'4 ( b'4) b'4 ( a'4 gis'4 e'4) fis'4 ( a'4 gis'4 e'4) fis'4 ( a'4) \divisioMinima \forceBreak
 ...
 d'4 e'4 ( \once \tweak #'font-size #-4 fis' ) fis'4 a'4 ( gis'4 fis'4 gis'4) e'4 ( fis'4)  \forceBreak
 a'4 ( fis'4) a'4 ( b'4) b'4 ( cis''4 a'4 gis'4) a'4 ( b'4) \divisioMinima
...
fis'2 ~ fis'2*3/2 ~ fis'2 e'2*7/2 ~ \divisioMinima
e'2*3/2 fis'2*6/2 ~ \divisioMinima
fis'2*5/2 ~ fis'2*7/4 cis'2*5/2 \divisioMinima
fis'2*4/2 ~ fis'2*4/2 e'2 \divisioMaxima
r4 fis'2*7/2 ~ fis'2 ~ fis'2*4/2 ~ fis'2*3/2 ~ fis'2*3/2 ~ fis'2*3/4 cis'2 ~ cis'2 \divisioMinima
e'2*5/2 fis'2*4/2 cis'2*4/2 ~ cis'4 \divisioMaxima
e'2 fis'2 e'2*4/2 ~ e'2*6/2 ~ \divisioMinima
e'2*6/2 cis'2*5/2 d'2*3/2 cis'2*5/2 r2*3/2 \divisioMaxima
d'2*3/2 cis'2*5/2 ~ cis'2 ~ cis'2*4/2 e'2*4/2 ~ e'2 ~ \divisioMinima
e'2 cis'2*4/2 ~ cis'2 ~ cis'2 ~ cis'2 \finalis
}
...
fis'2 e'2*3/2 d'2 cis'2*7/2 ~ \divisioMinima
cis'2*3/2 ~ cis'2*6/2 \divisioMinima
d'2*5/2 cis'2 gis2*3/4 a2*5/2 ~ \divisioMinima
a2*4/2 ~ a2*4/2 gis2 \divisioMaxima
b4 ~ b2*7/2 gis2 a2*4/2 cis'2*3/2 ~ cis'2*3/2 b2*3/4 ~ b2 a2 ~ \divisioMinima
a2*5/2 ~ a2*4/2 b2*4/2 a4 \divisioMaxima
cis'2 b2 ~ b2*4/2 a2*6/2 \divisioMinima
b2*6/2 ~ b2*5/2 a2*3/2 ~ a2*5/2 ~ a2*3/2 ~ \divisioMaxima
a2*3/2 ~ a2*5/2 b2 a2*4/2 ~ a2*4/2 fis4 gis4 ~ \divisioMinima
gis2 fis2*4/2 gis2 b2 a2 \finalis
}
...
b2*5/2 fis2 ~ fis2*3/4 ~ fis2*5/2 \divisioMinima
d2*4/2 b,2*4/2 e2 \divisioMaxima
r4 d2*7/2 ~ d2 fis2*4/2 ~ fis2*3/2 d2*3/2 ~ d2*3/4 fis2 ~ fis2 ~ \divisioMinima
fis2*5/2 d2*4/2 fis2*4/2 ~ fis4 \divisioMaxima
cis2 d2 cis2*4/2 ~ cis2*6/2 ~ \divisioMinima
cis2*6/2 fis2*5/2 ~ fis2*3/2 ~ fis2*5/2 ~ fis2*3/2 ~ \divisioMaxima
fis2*3/2 ~ fis2*5/2 ~ fis2 ~ fis2*4/2 cis2*4/2 e2 ~ \divisioMinima
e2 fis2*4/2 ~ fis2 ~ fis2 ~ fis2 \finalis
}
