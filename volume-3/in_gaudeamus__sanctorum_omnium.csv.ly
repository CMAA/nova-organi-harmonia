...
\header {
  title = \markup \center-column {"Gaudeamus... Sanctorum omnium" \vspace #1 }
  tagline = ""
  composer = ""
}
 ...
 #(include-special-characters)
  oddHeaderMarkup = \markup \fill-line {
    ...
    \center-column {
      ...
      \on-the-fly #not-first-page "Gaudeamus... Sanctorum omnium"
    }
    \line { \on-the-fly #print-page-number-check-first \fromproperty #'page:page-number-string }
  }
  evenHeaderMarkup = \markup \fill-line {
    \line { \on-the-fly #print-page-number-check-first \fromproperty #'page:page-number-string }
    \center-column { "Gaudeamus... Sanctorum omnium" }
    \line {}
  }
}
...
di -- em fe -- stum ce -- le -- brán -- tes sub ho -- nó -- _ re San -- ctó -- rum ó -- mni -- um: 
de quo -- rum so -- lem -- ni -- tá -- _ te gau -- dent An -- _ ge -- li, 
...
\tieDown   d'4 e'4  e'4 ( b'4 c''4) b'4 \divisioMinima
 ...
 g'4 a'4 a'4 b'4 ( d''4 b'4) a'4 ( b'4 a'4) g'4 b'4 a'4 ( d''4 d''4) b'4 b'4 ( cis''4 b'4) b'4 \divisioMaxima
...
e'2*4/2 ~ e'2 d'2*3/2 e'2*3/2 ~ e'2*3/2 ~ e'2 ~ \divisioMaior
e'4 ~ e'2 b4 ~ b2*3/2 e'2 d'2*3/2 c'2 d'2*3/2 ~ \divisioMinima
d'2 ~ d'4 ~ d'2*3/2 ~ d'2*4/2 ~ d'4 ~ d'2*4/2 e'2*3/2 d'4 \divisioMaxima
e'2 d'2*6/2 ~ d'4 ~ d'2*6/2 ~ \divisioMinima
d'2*3/2 ~ d'2*5/2 e'2*7/2 ~ e'2 ~ \divisioMaior
e'2 ~ e'4 d'2*6/2 ~ \divisioMinima
d'2*4/2 e'2*4/2 b2*3/2 ~ b2*5/2 ~ b2 \finalis
g'4 ~ g'2 ~ g'2 fis'2*4/2 e'4 ~ e'2 fis'2 \divisioMaxima
d'2*4/2 ~ d'2 ~ d'2*4/2 b4 ~ b2*3/2 ~ b4 g'2*3/2 ~ g'2*3/2 ~ g'2*4/2 ~ \divisioMinima
...
g2*4/2 e2 fis2*3/2 g2*3/2 a2*3/2 g2 ~ \divisioMaior
g4 fis2*3/2 e2*3/2 ~ e2 ~ e2*3/2 ~ e2 d2*3/2 \divisioMinima
b2 a4 g2*3/2 fis2*4/2 e4 fis2*4/2 ~ fis2*3/2 ~ fis4 \divisioMaxima
b2 ~ b2*6/2 ~ b4 a2*6/2 \divisioMinima
b2*3/2 g2*5/2 ~ g2 a2*5/2 b2 ~ \divisioMaior
b2 a2*7/2 \divisioMinima
b2*4/2 ~ b2*4/2 ~ b2*3/2 a2*5/2 g2 \finalis
r4 fis'2 e'2 d'2*4/2 ~ d'4 c'2 d'2 \divisioMaxima
a2*4/2 g2 a2*5/2 ~ a2*3/2 g4 r2*3/2 fis'2*3/2 e'2*4/2 ~ \divisioMinima
e'2 ~ e'2*4/2 d'2 ~ d'2 \divisioMaxima
c'2*4/2 d'2*4/2 ~ d'2*3/2 ~ \divisioMinima
d'4 e'2*5/2 ~ e'2 \divisioMaxima
a2*4/2 g2*4/2 ~ g2*3/2 ~ g2 ~ g2*3/2 a2 g2 \finalis
}

bassMusic = {
fis2 e2*4/2 \divisioMinima
d2*4/2 ~ d2 ~ d2*3/2 c2*3/2 ~ c2*3/2 e2 ~ \divisioMaior
e4 ~ e2*3/2 ~ e2*3/2 c2 b,2*3/2 a,2 b,2*3/2 ~ \divisioMinima
b,2 ~ b,4 ~ b,2*3/2 ~ b,2*4/2 ~ b,4 ~ b,2*4/2 ~ b,2*3/2 ~ b,4 \divisioMaxima
e2 ~ e2*6/2 fis4 ~ fis2*6/2 \divisioMinima
g2*3/2 b,2*5/2 c2 ~ c2*5/2 e2 ~ \divisioMaior
e2 fis2*7/2 \divisioMinima
g2*4/2 e2*4/2 ~ e2*3/2 ~ e2*5/2 ~ e2 \finalis
r2*12/2 b2 \divisioMaxima
fis2*4/2 g2 fis2*5/2 e2*3/2 ~ e4 r2*18/2 b2*6/2 g2*4/2 fis2*3/2 ~ \divisioMinima
fis4 e2*5/2 ~ e2 \divisioMaxima
